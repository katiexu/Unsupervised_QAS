...
if __name__ == '__main__':
    ...
    parser.add_argument("--baseline", type=float, default=0.7, help="rl adaptive baseline (default intialized value 0.7)")
    ...
    env = Env('REINFORCE', args.seed, args.emb_path, args.model_path, graph, cfg,
              data_path='circuit\\data\\data_8_qubits_20_gates.json', save=args.saved_maxcut, full_embedding=get_full_embedding)
