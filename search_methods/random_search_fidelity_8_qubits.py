...
if __name__ == '__main__':
    ...
    parser.add_argument('--emb_path', type=str, default='fidelity-rs-circuits_8_qubits_20_gates.pt')
    parser.add_argument("--threshold", type=float, default=0.75, help="fidelity threshold (default 0.8)")
    ...
    target = circuit_qnode(load_json("circuit\\data\\data_8_qubits_test.json")[0]["op_list"])
