...
from models.predictor import GNNPredictor, GNNPredictor_prediction
...
def random_search(embedding, dataset, args, target=None, graph=None, hamiltonian=None):
    ...
    if app == "fidelity":
        ...
        T1 = tim.time()
        selected_index, count, train_index, corr_search = GNNPredictor_prediction(embedding, args)
        T2 = tim.time()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_path', type=str, default='saved_logs\\gnn_predictor\\fidelity', help='predictor_based rs')
    parser.add_argument('--file_path', type=str, default='fidelity-gnn_predictor-circuits_4_qubits.pt')
